...
class SystemIdMapperClientTest {
    ...
    void shouldGetMappingsByCaseUrns() throws Exception {
        ...
        List<SystemIdMapper> result = client.getMappingsByCaseUrns(List.of("src1", "src2"), "type1", correlationId);
    ...
    void shouldGetMappingsByCaseIds() throws Exception {
        ...
        List<SystemIdMapper> result = client.getMappingsByCaseIds(List.of("tgtA", "tgtB"), "typeA", correlationId);
